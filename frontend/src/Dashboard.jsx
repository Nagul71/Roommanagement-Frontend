...
const Dashboard = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 flex flex-col font-sans">
      {/* Header */}
      <header className="bg-gradient-to-r from-violet-800 to-indigo-700 text-white p-4 shadow-xl sticky top-0 z-10">
        <div className="container mx-auto flex justify-between items-center">
          <div className="flex items-center space-x-2">
            ...
            <span className="hidden md:inline-block text-indigo-100 text-xs font-medium px-2 py-0.5 bg-indigo-700/40 rounded-full border border-indigo-400/30">Beta</span>
          </div>
          
          {/* Desktop Navigation */}
          <div className="hidden md:flex items-center space-x-4">
            <div className="flex space-x-1">
              <Link to="/dashboard" className="px-3 py-2 text-indigo-100 hover:bg-indigo-700/40 rounded-lg font-medium">
                Home
              </Link>
              <Link to="/browse-rooms" className="px-3 py-2 text-indigo-100 hover:bg-indigo-700/40 rounded-lg font-medium">
                Browse Rentals
              </Link>
              <Link to="/my-listings" className="px-3 py-2 text-indigo-100 hover:bg-indigo-700/40 rounded-lg font-medium">
                My Listings
              </Link>
            </div>
            
            <div className="flex items-center space-x-2">
              <button className="p-2 hover:bg-indigo-700/40 rounded-full relative group">
                <Bell size={20} />
                {notificationCount > 0 && (
                ...
                <span className="absolute top-full right-0 mt-1 w-max bg-white text-gray-800 text-xs p-1 rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity">Notifications</span>
              </button>
              <button className="p-2 hover:bg-indigo-700/40 rounded-full relative group">
                <HelpCircle size={20} />
                <span className="absolute top-full right-0 mt-1 w-max bg-white text-gray-800 text-xs p-1 rounded shadow-lg opacity-0 group-hover:opacity-100 transition-opacity">Help</span>
              </button>
              <div className="relative group">
                <button className="flex items-center space-x-2 py-1 px-2 hover:bg-indigo-700/40 rounded-lg ">
                  <div className="w-8 h-8 bg-white rounded-lg flex items-center justify-center text-indigo-700 font-bold z-200">
          ...
          <div className="md:hidden flex items-center">
            <button 
              ...
              className="p-2 rounded-md hover:bg-indigo-700/40 focus:outline-none"
            >
        ...
        {mobileMenuOpen && (
          <div className="md:hidden mt-4 bg-indigo-800/95 rounded-xl p-4 backdrop-blur-sm animate-fadeIn shadow-xl">
            <div className="flex items-center bg-indigo-700/60 rounded-lg px-3 py-2 mb-4">
              <Search size={16} className="text-indigo-200 mr-2" />
              <input 
                type="text" 
                placeholder="Search for rentals..." 
                className="bg-transparent border-none text-sm text-white placeholder-indigo-200 focus:outline-none w-full"
              />
            </div>
            <nav className="flex flex-col space-y-1">
              <Link to="/dashboard" className="flex items-center px-3 py-2 text-white rounded-md hover:bg-indigo-700">
                <Home size={20} className="mr-3" /> Dashboard
              </Link>
              <Link to="/browse-rooms" className="flex items-center px-3 py-2 text-white rounded-md hover:bg-indigo-700">
                <CalendarDays size={20} className="mr-3" /> Browse Rentals
              </Link>
              <Link to="/create-listing" className="flex items-center px-3 py-2 text-white rounded-md hover:bg-indigo-700">
                <Home size={20} className="mr-3" /> List Your Property
              </Link>
              <div className="border-t border-indigo-600/50 my-2"></div>
              <Link to="/profile" className="flex items-center px-3 py-2 text-white rounded-md hover:bg-indigo-700">
                <User size={20} className="mr-3" /> My Profile
              </Link>
              <Link to="/settings" className="flex items-center px-3 py-2 text-white rounded-md hover:bg-indigo-700">
              ...
              <button 
                ...
                className="flex items-center px-3 py-2 text-white rounded-md hover:bg-indigo-700 w-full text-left"
              >
      ...
      <main className="flex-grow container mx-auto px-4 py-8 md:py-12">
        {/* Welcome Banner */}
        <div className="bg-gradient-to-r from-violet-600 to-indigo-600 rounded-2xl shadow-lg mb-10 overflow-hidden relative">
          ...
          <div className="relative z-10 px-6 py-8 md:p-10 flex flex-col md:flex-row items-center justify-between">
            ...
            <div className="flex space-x-3">
              <button 
                ...
                className="bg-white text-indigo-700 px-5 py-2.5 rounded-lg font-medium hover:bg-indigo-50 transition shadow-md"
              >
                Browse Rentals
              </button>
              <button 
                onClick={() => navigate('/create-listing')} 
                className="bg-indigo-500 text-white px-5 py-2.5 rounded-lg font-medium hover:bg-indigo-600 transition border border-indigo-400 shadow-md"
              >
                List a Property
              </button>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-10">
          <div className="bg-white rounded-xl shadow-sm p-4 md:p-5 border border-indigo-100 hover:border-indigo-300 transition-all group">
            <div className="flex items-center justify-between mb-3">
              <div className="w-10 h-10 rounded-lg bg-indigo-100 flex items-center justify-center group-hover:bg-indigo-600 transition-colors">
                <Home size={20} className="text-indigo-600 group-hover:text-white transition-colors" />
              </div>
              <span className="text-xs font-medium px-2 py-1 bg-indigo-50 text-indigo-600 rounded-md">All Time</span>
            </div>
          ...
          <div className="bg-white rounded-xl shadow-sm p-4 md:p-5 border border-indigo-100 hover:border-indigo-300 transition-all group">
            <div className="flex items-center justify-between mb-3">
              <div className="w-10 h-10 rounded-lg bg-indigo-100 flex items-center justify-center group-hover:bg-indigo-600 transition-colors">
                <MessageSquare size={20} className="text-indigo-600 group-hover:text-white transition-colors" />
              </div>
              <span className="text-xs font-medium px-2 py-1 bg-indigo-50 text-indigo-600 rounded-md">Unread</span>
            </div>
            <p className="text-xl font-bold text-gray-800">0</p>
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {/* Rent Room Option */}
          <div className="bg-white rounded-2xl shadow-md overflow-hidden border border-indigo-100 hover:shadow-lg transition-all group">
            <div className="p-6 md:p-8">
              <div className="flex items-center justify-between mb-6">
                <div className="w-14 h-14 bg-indigo-600 rounded-2xl flex items-center justify-center shadow-inner">
                  <Home size={28} className="text-white" />
                </div>
                <span className="text-sm font-medium px-3 py-1 bg-indigo-100 text-indigo-700 rounded-full">Host</span>
              </div>
              ...
              <Link to="/create-listing" className="block">
                <button className="w-full bg-gradient-to-r from-indigo-600 to-violet-600 hover:from-indigo-700 hover:to-violet-700 text-white py-3 px-4 rounded-xl font-medium transition shadow flex items-center justify-center group-hover:shadow-lg">
                  List Your Property
          ...
          <div className="bg-white rounded-2xl shadow-md overflow-hidden border border-indigo-100 hover:shadow-lg transition-all group">
            <div className="p-6 md:p-8">
              ...
              <Link to="/browse-rooms" className="block">
                <button className="w-full bg-gradient-to-r from-violet-600 to-indigo-600 hover:from-violet-700 hover:to-indigo-700 text-white py-3 px-4 rounded-xl font-medium transition shadow flex items-center justify-center group-hover:shadow-lg">
                  Browse Rentals
                  <ChevronRight size={18} className="ml-1" />
                </button>
              </Link>
        ...
        <div className="mt-10">
          <div className="flex items-center justify-between mb-5">
            ...
            <Link to="/activity" className="text-sm text-indigo-600 hover:text-indigo-800 font-medium flex items-center">
          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="mb-6 md:mb-0">
              <div className="flex items-center justify-center md:justify-start">
                ...
                <h2 className="text-xl font-bold text-indigo-700">RentEase</h2>
                <span className="ml-2 text-xs font-medium px-2 py-0.5 bg-indigo-100 text-indigo-800 rounded-full">Beta</span>
              </div>
              <p className="text-gray-600 text-sm mt-2 text-center md:text-left">Find your perfect rental property</p>
            </div>
            
            <div className="flex flex-wrap justify-center gap-6 mb-6 md:mb-0">
              <a href="#" className="text-gray-600 text-sm hover:text-indigo-700 transition-colors">About Us</a>
              <a href="#" className="text-gray-600 text-sm hover:text-indigo-700 transition-colors">Help Center</a>
              <a href="#" className="text-gray-600 text-sm hover:text-indigo-700 transition-colors">Privacy</a>
              <a href="#" className="text-gray-600 text-sm hover:text-indigo-700 transition-colors">Terms</a>
            </div>
            
            <div className="flex space-x-4">
              <a href="#" className="w-8 h-8 rounded-full bg-slate-100 flex items-center justify-center text-gray-600 hover:bg-indigo-100 hover:text-indigo-600 transition-colors">
